...
// console.log(myName + ' is ' + heightCentimeters + ' cm tall and weighs ' + weightKilograms + ' kg.');
alert(myName + ' is ' + convertInchesToCentimeters(heightInches) + ' cm tall and weighs ' + weightKilograms + ' kg.');